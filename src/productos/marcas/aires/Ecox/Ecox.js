...
render(){
  ...
  <div style={{display:'flex', backgroundColor: 'dodgerblue',height:'90vh'}}>
    <div style={{marginTop:'5vh', width:'20%'}}>
     <Link to= "/nav/productos/Aires/ecox1" className='button' style={{marginLeft: '5vh', display: 'block'}} onClick={(e) => this.handleLink(0,e)}> ECOX Inverter 12,000 BTU </Link>
     <Link to= "/nav/productos/Aires/ecox2" className='button' style={{marginLeft: '5vh', display: 'block'}} onClick={(e) => this.handleLink(1,e)}> ECOX Inverter 36,000 BTU </Link>
